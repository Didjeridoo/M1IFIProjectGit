...
public class PluginMenuItemBuilderColor {
	private JMenu menu;

	private Map<String, Constructor<? extends IColorStrategy>> constructors;

	private ActionListener listener;

	private static Logger logger = Logger.getLogger("plug.Menu");

	public PluginMenuItemBuilderColor(
			Map<String, Constructor<? extends IColorStrategy>> mc,
